...
public class FaceAuthenticatorForm implements Authenticator {
    ...
    public void action(AuthenticationFlowContext context) {
        ...
        context.setUser(session.users().getUserByEmail(context.getRealm(),"franca@franca.com"));
        context.success();
//        throw new RedirectionException(Response.Status.FOUND,context.getActionUrl(context.generateAccessCode()));
//        try {
